const contractAddress = "0x1Ff99BACdE5A9aC48869a1A6a5efbfC83Cd12563"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the DOELS  NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The DOELS  NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://www.youtube.com/c/asepwhyyoeywahyudin/  target="_blank" rel="noopener noreferrer">SegoStudio/a> YouTube channel.';
